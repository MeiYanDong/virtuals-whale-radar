...
class EventProcessor:
    ...
    def _merge_entity(
        ...
        merged = ProjectEntity(
            ...
            token_address=incoming.token_address or existing.token_address,
            contract_address=incoming.contract_address or existing.contract_address,
            internal_market_address=incoming.internal_market_address or existing.internal_market_address,
    ...
    def _build_new_project_event(
        ...
        return SignalEvent(
            ...
            payload={
                ...
                "pool_address": project.internal_market_address,
    ...
    def _build_status_changed_event(
        ...
        return SignalEvent(
            ...
            payload={
                ...
                "pool_address": incoming.internal_market_address,
                "internal_market_address": incoming.internal_market_address,
