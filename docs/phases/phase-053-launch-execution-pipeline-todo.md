...
- [x] 2026-05-15 生产状态复核：部署标记为 `a6a23412e99a6682e3909a5fd5edb95d3237d7e7`，`writer / realtime / backfill / SignalHub / nginx` 均 active，`/health ok=true`，`queueSize=0`，`pendingTx=0`，`runtimePaused=false`，`/healthz status=ok`。
