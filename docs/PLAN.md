...
- 2026-05-20 已从生产 SignalHub upcoming feed 选出 `PROFIT` 与 `MTR` 两个候选，并完成非广播预热模拟；候选记录见 `docs/phases/phase-061-live-candidates-2026-05-20.md`。当前结论是 `MTR` 更适合作为第一次完整 runbook 演练，真实广播前仍必须单独确认预算、授权和 timer 服务范围。
